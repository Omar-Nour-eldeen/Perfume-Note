...
const slides = [
  {
    id: 1,
    image: siteAssets.hero2,
    video: siteAssets.heroVideo,
    ...
    cta_en: "Our featured products",
    cta_ar: "منتجاتنا المميزة",
  }
];
...
export function Hero() {
  ...
  return (
    <section className="relative w-full h-[85vh] min-h-[500px] bg-[#f8f5f0]">
      {/* Carousel */}
